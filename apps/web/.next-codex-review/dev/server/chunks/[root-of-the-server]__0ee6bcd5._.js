...
"[project]/apps/web/src/modules/auth/constants.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AUTH_COOKIE_NAME = "study_auth_token";
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$modules$2f$auth$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/modules/auth/constants.ts [middleware] (ecmascript)");
;
;
function proxy(request) {
    const token = request.cookies.get(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$modules$2f$auth$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["AUTH_COOKIE_NAME"])?.value;
    if (!token) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ee6bcd5._.js.map